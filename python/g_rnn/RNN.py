...
class UnRolledRNN_Model(Block):
    ...
    def forward(self, inputs):
        ...
        character2 = emd[:,1,:]
        character3 = emd[:,2,:]
        c1_hidden = self.dense1(character1) # green arrow in diagram for character 1
        c2_hidden = self.dense1(character2) # green arrow in diagram for character 2
        c3_hidden = self.dense1(character3) # green arrow in diagram for character 3
